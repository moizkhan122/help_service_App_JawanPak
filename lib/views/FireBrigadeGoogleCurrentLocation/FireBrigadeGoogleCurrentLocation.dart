...
import 'package:flutter_application_1/view_model/FireBrigadeGooCurLocViewModel.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:stacked/stacked.dart';

class FireBrigadeGoogleCurrentLocation extends StatelessWidget {
  const FireBrigadeGoogleCurrentLocation({super.key});
  
  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<FireBrigadeGooCurLocViewModel>.reactive(
      viewModelBuilder: () => FireBrigadeGooCurLocViewModel(),
                ...
                return Column(
                  children: [
                    ...
                    elevatedButton(
                      ...
                      onpress: (){
                        viewModel.fireBrigageReqSend(context);
                        Navigator.of(context).pop();
                      }),
                  ],
                );
